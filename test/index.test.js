...
describe(`time ago`, function()
{
	...
	it(`should fallback to "short" for Twitter for autogenerated locales`, function()
	{
		const time_ago = new javascript_time_ago('fr')
		time_ago.format(Date.now() - 3 * 60 * 60 * 1000, 'twitter').should.equal('il y a 3 h')
	})
